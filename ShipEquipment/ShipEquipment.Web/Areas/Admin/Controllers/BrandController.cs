...
namespace ShipEquipment.Web.Areas.Admin.Controllers
{
    public class BrandController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Description,Active")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Description,Active")] Brand brand)
        {
            if (ModelState.IsValid)
            {
